...
| File | Contents |
|---|---|
| `findings.json` | The 32 findings of the audit of commit `ae75ca9` (2026-09-13). Fields: `id`, `severity`, `area`, `location`, `claim` (as written), `actual` (what the artifacts show), `category`, `pinned`, `public` |
